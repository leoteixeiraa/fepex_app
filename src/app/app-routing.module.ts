...
const routes: Routes = [
  ...
  { path: 'anteriores', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'anteriores/:ano', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'anteriores/:ano/:categoria', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'anteriores/:ano/:categoria/:tipo', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'anteriores-result/:ano/:categoria/:tipo', loadChildren: './pages/trabalhos-anteriores-result/trabalhos-anteriores-result.module#TrabalhosAnterioresResultPageModule', canActivate: [AuthGuard] },
  { path: 'anteriores-result-detail/:id', loadChildren: './pages/trabalhos-anteriores-result-detail/trabalhos-anteriores-result-detail.module#TrabalhosAnterioresResultDetailPageModule', canActivate: [AuthGuard] },
  ...
  { path: 'modalresumo', loadChildren: './pages/modalresumo/modalresumo.module#ModalresumoPageModule' },  { path: 'novasideias', loadChildren: './pages/novasideias/novasideias.module#NovasideiasPageModule' },
