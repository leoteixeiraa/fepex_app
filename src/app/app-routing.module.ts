...
const routes: Routes = [
  ...
  { path: 'trabalhos-anteriores/:ano', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'trabalhos-anteriores/:ano/:categoria', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'trabalhos-anteriores/:ano/:categoria/:tipo', loadChildren: './pages/trabalhos-anteriores/trabalhos-anteriores.module#TrabalhosAnterioresPageModule' },
  { path: 'trabalhos-anteriores-result/:ano/:categoria/:tipo', loadChildren: './pages/trabalhos-anteriores-result/trabalhos-anteriores-result.module#TrabalhosAnterioresResultPageModule', canActivate: [AuthGuard] },
